...
%----------------------------------------------------
%	LIST LINGUAGENS DE PROGRAMAÇÃO
%----------------------------------------------------
\renewcommand{\lstlistingname}{Código}
\lstdefinelanguage{JavaScript}{
  keywords={break, case, catch, const, continue, debugger, default, delete, do, else, export, finally, for, function, if, import, in, instanceof, let, new, return, switch, throw, try, typeof, var, void, while, with, yield, async, await},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/},
  morestring=[b]',
...
\preambulo{\imprimirtipotrabalho\ apresentada a Universidade Estadual de Mato Grosso do Sul – Unidade Nova Andradina – como um dos requisitos para aprovação de Estágio Curricular Supervisionado Obrigatório.\\
}
...
\newcommand{\citelower}[1]{(\citeauthoronline{#1}, \citeyear{#1})}
...
\pdfbookmark[0]{Lista de Códigos}{lstlistings}
\lstlistoflistings
\cleardoublepage
\makeatother
}
...
% Se a entrega for com resultados parciais adicione o capítulo de cronograma, caso contrário, retire o % da linha de baixo para inserir o cronograma.
